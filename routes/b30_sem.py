...
@b30_sem_bp.route("/api/lookup-rate", methods=["POST"])
def lookup_rate():
...
@b30_sem_bp.route("/api/reload-rate-index", methods=["POST"])
...
@b30_sem_bp.route("/api/recent-target-options", methods=["GET"])
...
@b30_sem_bp.route("/api/recent-datasets/b30_aja_recent_datasets.csv", methods=["GET"])
